...
layui.use('table', function(){
        ...
        table.render({
            ...
            ,height: 'full-130'
            ,even:true
            ,url:m_url+'/sechoshospitalized/listData'
            ,method:'get'
            ,cols: [[
                {checkbox:true}
                                ...
                                ,{field:'medicalNumber', width:80, title: '住院病历号', sort: true}
                                ,{field:'patid', width:80, title: '住院患者id', sort: true}
                                ,{field:'patientRowGuid', width:80, title: '患者guid', sort: true}
                                ,{field:'hospitalizedStatus', width:80, title: '住院状态', sort: true}
        ...
        $('#infoDel').on('click', function(){
            layer.confirm('你确定删除吗！', function(index){
                ...
                $.ajax({
                    url:m_url+'/sechoshospitalized/delete',
