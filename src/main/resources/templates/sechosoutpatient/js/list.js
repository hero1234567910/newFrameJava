...
layui.use('table', function(){
        ...
        table.render({
            ...
            ,height: 'full-130'
            ,even:true
            ,url:m_url+'/sechosoutpatient/listData'
            ,method:'get'
            ,cols: [[
                {checkbox:true}
                                ...
                                ,{field:'medicalNumber', width:80, title: '门诊病历号', sort: true}
                                ,{field:'patid', width:80, title: '卫宁病人id', sort: true}
        ...
        $('#infoDel').on('click', function(){
            layer.confirm('你确定删除吗！', function(index){
                ...
                $.ajax({
                    url:m_url+'/sechosoutpatient/delete',
